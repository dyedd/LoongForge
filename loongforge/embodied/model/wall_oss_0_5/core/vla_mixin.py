...
from loongforge.embodied.model.wall_oss_0_5.core.action.moe import SparseMoeBlock, TokenTypeRouter
from loongforge.embodied.model.wall_oss_0_5.core.action.processor import ActionProcessor
from loongforge.embodied.model.wall_oss_0_5.core.attention.mask import (
...
class ActionModelMixMin:
    ...
    def scatter_flow_action_embeddings(
        ...
        """Scatter flow action embeddings."""
    ...
    def _update_joint_attention_mask_2d(
        ...
        """Update joint attention mask 2d."""
...
class ActionGenerationMixin(GenerationMixin):
    ...
    def to_bfloat16_for_selected_params(self, fsdp_plugin=None, accelerator=None):
        ...
        if fsdp_plugin:
            ...
            # Step 2: Wrap the outer module with FSDP using the BF16 policy
